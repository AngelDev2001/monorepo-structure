...
): Promise<Quotation[]> => fetchCollection<Quotation>(quotationsRef, whereClauses);
...
export const addQuotation = async (quotation: Partial<Quotation>): Promise<void> =>
  setDocument<Partial<Quotation>>(quotationsRef.doc(quotation.id), quotation);

export const updateQuotation = async (
  quotationId: string,
  quotation: Partial<Quotation>
): Promise<void> => updateDocument<Partial<Quotation>>(quotationsRef.doc(quotationId), quotation);
